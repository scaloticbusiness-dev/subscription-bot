...
//   2. Checks Google Sheets: if this Discord username already has an
//      Active, non-expired subscription (e.g. they left and rejoined),
//      automatically gives them the "winner" role back and refreshes
//      the row with their (possibly new) Discord user ID.
...
const WELCOME_MESSAGE_TEMPLATE = `Καλωσήρθες στο community, {mention}

Είμαστε ενθουσιασμένοι να σε έχουμε μαζί μας. Αυτά είναι τα επόμενα βήματα:

Ρίξε μια ματιά στους #rules μας για τις οδηγίες της κοινότητας
Πες ένα «γεια» στο #general
Μην διστάσεις να επικοινωνήσεις μαζί μας αν έχεις απορίες!`;
