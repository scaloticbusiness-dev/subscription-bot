...
const { addRoleToUser, sendDirectMessage } = require('./discord');
...
const { ensureTranscriptsSheet, saveTranscript } = require('./transcripts');
...
async function registerSlashCommands(c) {
    ...
    console.log('Registered /faq, /announce-lesson, /transcribe, /poll, /send-replay, and /migrate-to-yearly slash commands.');
}
/**
