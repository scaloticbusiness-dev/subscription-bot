...
// | F Reminder 1h Sent | G Reminder 10min Sent
...
async function markReminderSent(rowNumber, column) {
  const columnLetter = { reminder24hSent: 'E', reminder1hSent: 'F', reminder10minSent: 'G' }[column];
