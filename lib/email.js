...
// Once a custom domain is verified in the Resend dashboard, this can be
// swapped for something like "Lotik Shorts <hello@yourdomain.com>".
const FROM_ADDRESS = 'Lotik Shorts <onboarding@resend.dev>';
