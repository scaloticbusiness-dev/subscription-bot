 ...
 * lotik.gr lead form, thanking them and setting expectations for follow-up.
 */
...
Σε ευχαριστώ πολύ που συμπλήρωσες τη φόρμα ενδιαφέροντος για το course μου! Έλαβα τα στοιχεία σου και θα επικοινωνήσω μαζί σου προσωπικά μέσα στις επόμενες 24-48 ώρες.
 ...
 * paying subscriber a few days after filling out the form. Generic
 * encouragement content — easy to personalize further later.
 */
...
Ήθελα απλά να επανέλθω σχετικά με το ενδιαφέρον σου για το YouTube course μου. Ξέρω ότι το να ξεκινήσεις ένα κανάλι από το μηδέν μπορεί να φαίνεται τρομακτικό — έλλειψη γνώσεων, αβεβαιότητα για το niche, ή απλά δεν ξέρεις από πού να ξεκινήσεις.

Το course είναι φτιαγμένο ακριβώς για αυτό: να σου δώσει ένα ξεκάθαρο, βήμα-βήμα σύστημα ώστε να μην χρειάζεται να τα ανακαλύψεις όλα μόνος/η σου.

Αν έχεις ακόμα ερωτήσεις ή θες να μιλήσουμε, απάντησε ελεύθερα σε αυτό το email — χαίρομαι πάντα να βοηθάω.
...
Lotik`;
  ...
  await sendEmail({
    to: email,
    subject: 'Ακόμα σκέφτεσαι το YouTube channel σου;',
    text,
  });
