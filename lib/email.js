...
async function sendLeadAutoReply({ firstName, email, variant = 'A' }) {
  ...
  const subject = AUTO_REPLY_SUBJECT_VARIANTS[variant] || AUTO_REPLY_SUBJECT_VARIANTS.A;
